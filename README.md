...
- 如果你在中国大陆，并且没有良好的网络环境（如高速访问外网，请修改脚本中第55行为docker pull docker.mirrors.sjtug.sjtu.edu.cn/kagurazakanyaa/palworld  注意隔行！，
...
- 以及第97行为if docker pull docker.mirrors.sjtug.sjtu.edu.cn/kagurazakanyaa/palworld | grep -q 'Downloaded newer image'; then
